...
#Commenting out this code because I can use the tif I made for this instead.
...
#extract land use proportion

land_use_prop <- raster::extract(gb2019prop, col)
hymenoptera$land_use_prop <- land_use_prop

#remove temp vectors and data frames
